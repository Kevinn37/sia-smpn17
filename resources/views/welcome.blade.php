...
@section('konten')
        ...
        <section class="hero-wrapper" id="hero">
            <div class="hero-isi">
                ...
                <div class="hero-teks" data-aos="fade-right">
                    ...
                    <h1 class="hero-judul">
                        Akademik Lebih <span class="hero-judul-aksen">Modern</span>,
                        Sekolah Lebih <span class="hero-judul-aksen">Maju</span>
                    </h1>
                    <p class="hero-deskripsi">
                        SIAKAD hadir untuk membantu SMP Negeri 17 Makassar
                        dalam mengelola kegiatan akademik secara digital —
                        dari presensi QR Code hingga monitoring nilai siswa.
                    </p>
                    <div class="hero-aksi">
                ...
                <div class="hero-gambar" data-aos="fade-left">
                    ...
                    <div class="hero-stat-card hero-stat-2" data-aos="zoom-in" data-aos-delay="300">
                        ...
                        <div>
                            <span class="hero-stat-angka">QR</span>
            ...
            <div class="section-isi">
                ...
                <div class="tentang-teks" data-aos="fade-left">
                    ...
                    <p class="tentang-deskripsi">
                        SMP Negeri 17 Makassar adalah sekolah menengah pertama negeri
                        yang berkomitmen dalam menghadirkan pendidikan berkualitas
                        bagi generasi muda Makassar.
                    </p>
                    <p class="tentang-deskripsi">
                        Dengan SIAKAD, proses akademik sekolah kini dikelola secara
                        digital — mulai dari absensi, penilaian, jadwal, hingga
                        monitoring oleh kepala sekolah, semua dalam satu sistem terpadu.
                    </p>
                    <div class="tentang-info-grid">
                        ...
                        <div class="tentang-info-item">
                            ...
                            <span>Sekolah Negeri Terakreditasi</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="visimisi-grid">
                    ...
                    <div class="visimisi-card visimisi-visi" data-aos="fade-right">
                        ...
                        <p>
                            ...
                            berkarakter, dan berdaya saing dalam era global
            ...
            <div class="section-isi section-isi-tengah">
                ...
                <div class="fitur-grid">
                    ...
                    <div class="fitur-card" data-aos="fade-up" data-aos-delay="0">
                        <div class="fitur-card-icon fitur-icon-kuning">
                            <i data-lucide="qr-code"></i>
                        </div>
                    ...
                    <div class="fitur-card" data-aos="fade-up" data-aos-delay="100">
                        <div class="fitur-card-icon fitur-icon-biru">
                    ...
                    <div class="fitur-card" data-aos="fade-up" data-aos-delay="200">
                        <div class="fitur-card-icon fitur-icon-fuchsia">
                    ...
                    <div class="fitur-card" data-aos="fade-up" data-aos-delay="300">
                        <div class="fitur-card-icon fitur-icon-hijau">
                ...
                <div class="lokasi-grid" data-aos="fade-up">
                    ...
                    <div class="lokasi-maps">
                        <iframe
                            ...
                            width="100%" height="320" style="" allowfullscreen="" loading="lazy"
    ...
    <footer class="footer-wrapper">
        <div class="footer-isi">
            ...
            <p class="footer-copy">
                &copy; {{ date('Y') }} SIAKAD SMP Negeri 17 Makassar. Sistem Informasi Akademik Digital.
            </p>
