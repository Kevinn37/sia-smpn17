...
@section('konten')
    ...
    <div class="page-header">
        <div class="page-header-teks">
            <h2>Tambah Jadwal</h2>
            <p>Tambahkan jadwal pelajaran baru</p>
        </div>
    ...
    <div class="neo-card form-card" data-aos="fade-up">
        ...
        <form action="{{ route('admin.jadwal.simpan') }}" method="POST" class="form-grid">
            @csrf
            ...
            <div class="form-field">
                ...
                <input type="time" id="jam_mulai" name="jam_mulai" class="neo-input" value="{{ old('jam_mulai') }}"
                    required>
            </div>
