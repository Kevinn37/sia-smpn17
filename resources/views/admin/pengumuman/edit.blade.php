...
@section('konten')
    ...
    <div class="page-header">
        <div class="page-header-teks">
            ...
            <p>Perbarui pengumuman <strong>{{ Str::limit($result->judul, 40) }}</strong></p>
        </div>
    ...
    <div class="neo-card form-card" data-aos="fade-up">
        ...
        <form action="{{ route('admin.pengumuman.update', $result->id_pengumuman) }}" method="POST" class="form-grid">
            @csrf
            ...
            <div class="form-field form-field-full">
                ...
                <input type="text" id="judul" name="judul" class="neo-input"
                    value="{{ old('judul', $result->judul) }}" required>
            </div>
            ...
            <div class="form-field">
                ...
                <select id="ditujukan" name="ditujukan" class="neo-select" required>
                    ...
                    <option value="semua" {{ old('ditujukan', $result->ditujukan) == 'semua' ? 'selected' : '' }}>Semua
                        Pengguna</option>
                    <option value="siswa" {{ old('ditujukan', $result->ditujukan) == 'siswa' ? 'selected' : '' }}>Siswa
                    </option>
                    <option value="guru" {{ old('ditujukan', $result->ditujukan) == 'guru' ? 'selected' : '' }}>Guru
                    </option>
                </select>
            </div>
            ...
            <div class="form-field">
                ...
                <input type="date" id="tanggal_tayang" name="tanggal_tayang" class="neo-input"
                    value="{{ old('tanggal_tayang', $result->tanggal_tayang) }}" required>
            </div>
            ...
            <div class="form-field">
                ...
                <input type="date" id="tanggal_berakhir" name="tanggal_berakhir" class="neo-input"
                    value="{{ old('tanggal_berakhir', $result->tanggal_berakhir) }}">
            </div>
            ...
            <div class="form-field form-field-full">
                ...
                <textarea id="isi" name="isi" class="neo-textarea" rows="6" required>{{ old('isi', $result->isi) }}</textarea>
            </div>
