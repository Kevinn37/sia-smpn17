    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .error-box {
            ...
            box-shadow    : 10px 10px 0px #ffe845;
            padding       : 3rem;
            text-align    : center;
            max-width     : 480px;
            width         : 100%;
        ...
        .error-icon i { width: 32px; height: 32px; color: #111111; }
        .error-judul {
            font-family   : 'Archivo', sans-serif;
            font-size     : 1.5rem;
            font-weight   : 900;
...
<body>
    <div class="error-box">
        <div class="error-kode">500</div>
        <div class="error-icon">
            <i data-lucide="alert-triangle"></i>
        </div>
        <h1 class="error-judul">Terjadi Kesalahan Server</h1>
        <p class="error-pesan">
            Server mengalami masalah teknis. Tim kami sedang memperbaikinya.
